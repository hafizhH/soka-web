...
export default function Post() {
  ...
  return (
    <div className='w-full px-[10%] pt-8 pb-16 flex flex-row space-x-16 bg-gray-200'>
      <div className='w-[70%] flex flex-col space-y-12'>
        <div className='flex flex-col'>
          <div className='text-4xl font-semibold text-gray-600 leading-snug'>{ (post) ? post.fields.title : '' }</div>
      ...
      <div className='mt-8 w-[25%] flex flex-col space-y-6'>
